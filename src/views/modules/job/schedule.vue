    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="isAuth('sys:schedule:pause')" type="text" size="small" @click="pauseHandle()">
            暂停
          </el-button>
          <el-button v-if="isAuth('sys:schedule:resume')" type="text" size="small"
                     @click="resumeHandle()">恢复
          </el-button>
          <el-button v-if="isAuth('sys:schedule:run')" type="text" size="small" @click="runHandle()">
            立即执行
          </el-button>
        </template>
      </el-table-column>
